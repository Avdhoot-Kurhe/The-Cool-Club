        ...
        <div className='bodycarepageright'>
            ...
            <div className='bodycarepagerighttopdivin'>
                ...
                <div className='bodycarepagerighttopdivinimg'>
                    ...
                    <div className='bodycarepagerighttopdivinname'>
                        <p className='bodycarepagerighttopdivinnamein'>Body Wash & Shower Gel</p>
                    </div>
                </div>
            ...
            <div className='filtersortdiv'>
                <div className='filterdiv'>
                    <p className='filterdivpara'>Filter By : </p>
                    <div className='filterdivproducttype'>
                    <Menu>
  <MenuButton as={Button} rightIcon={<ChevronDownIcon />} className="sortproducthead">
    PRODUCT TYPE
  </MenuButton>
  <MenuList>
            ...
            <div className='bodycareproductsdiv'>
                <div className='bodycareproducts1'>
                    <div className='bodycareproductsinside'>
                        ...
                        <div className='bodycareproductsinsideimg'>
                            <img className='bodycareproductsinsideimgin' src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.219/dw/image/v2/BBDL_PRD/on/demandware.static/-/Sites-master-catalog/default/dw4b491d20/crop/026535136_crop.jpg?sw=500&sh=600&sm=fit&q=75&yocs=o_s_" alt="" />
                        </div>

                        <div className='bodycareproductsinsidead'>
                            <p className='bodycareproductsinsideadpara'>New Fragrance</p>
                        </div>

                        <div className='bodycareproductsinsidename'>
                            <p className='bodycareproductsinsidenamepara'>Dream Bright</p>
                        </div>

                        <div className='bodycareproductsinsidetype'>
                            <p className='bodycareproductsinsidetypein'>Fine Fragrance Mist</p>
                        </div>

                        <div className='bodycareproductsinsideprice'>
                            <p className='bodycareproductsinsidepricein'>$17.50</p>
                        </div>

                        <div className='bodycareproductsinsideaddtobag'>
                            <button className='bodycareproductsinsideaddtobagbtn'>ADD TO BAG</button>
                        </div>

                        <div className='bodycareproductsinsiderating'></div>
                ...
                <div className='bodycareproducts1'>
                    <div className='bodycareproductsinside'></div>
                    <div className='bodycareproductsinside'></div>
                    <div className='bodycareproductsinside'></div>
                    <div className='bodycareproductsinside'></div>
                </div>
